...
-- ---------------------------------------------------------------------------
-- Vector-similarity search functions (called from the backend via RPC).
-- ---------------------------------------------------------------------------
...
revoke all on function public.pk_match_case_chunks(vector, int, text)
  from anon, authenticated;
revoke all on function public.pk_match_statute_sections(vector, int, text)
  from anon, authenticated;
